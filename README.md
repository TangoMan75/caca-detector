...
2. <img src="./images/pile_of_poo_notification.png" alt="Caca Icon" width="18" /> If the extension detects "caca" anywhere on the page or in the code, the _"pile of poo"_ icon in the toolbar will display a red spot.
